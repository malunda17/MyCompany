...
$identityServerCNs = "mycompany.identityservice", "localhost"
$webApiCNs = "mycompany.agentapplication", "localhost"
...
$identityServerCertPath = "src/identityservice/certs"
$webApiCertPath = "src/agentapplication/certs"
